...
import br.com.mytravels.apimytravels.security.AccountCredentialsVO;
import br.com.mytravels.apimytravels.security.jwt.JwtTokenProvider;
...
public class AuthController {
	...
	public ResponseEntity signin(@RequestBody AccountCredentialsVO data) {
		try {
			...
			model.put("idUser", user.getPessoa().getKey());
			model.put("name", user.getPessoa().getNome());
			model.put("idTransportadora", user.getPessoa().getTransportadora().getKey());
